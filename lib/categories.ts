export type Category = 'hat_bar' | 'jewelry' | 'food_bev' | 'beauty' | 'kids_parties' | 'entertainment'
...
export const CATEGORY_META: Record<Category, { label: string; accent: string; bg: string; text: string; image?: string }> = {
  ...
  kids_parties: { label: 'Kids Parties', accent: '#3E6FB0', bg: '#DEE9F8', text: '#1E3E66' },
  entertainment: { label: 'Entertainment', accent: '#7B4FA0', bg: '#EBE1F5', text: '#4A2A66' },
}

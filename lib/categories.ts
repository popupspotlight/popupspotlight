...
export const CATEGORY_META: Record<Category, { label: string; accent: string; bg: string; text: string }> = {
  ...
  jewelry: { label: 'Jewelry', accent: '#B0447A', bg: '#F8E1EC', text: '#6E1F41' },
  food_bev: { label: 'Food and bev', accent: '#C98A1F', bg: '#FBEBCE', text: '#6E4A0D' },
  beauty: { label: 'Beauty', accent: '#3C7A6A', bg: '#DDEEE8', text: '#1D4A3E' },
}
